 ...
 * @param ran1 Rango de inicio el cual será otorgado por el usuario. 
 * @param ran2 Rango de fin el cual es otorgado por el usuario.
 * @param m Termino dependiente el cual multiplicara a x.
 * @param b Termino independiente el cual se sumara a la multiplicación.
 * @return void. 
*/
 ...
 * @param ran1 Rango de inicio.
 * @param ran2 Rango de fin.
 * @return  void. 
*/
